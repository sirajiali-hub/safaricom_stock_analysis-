print("="*50)
print("STEP 6: Creating Project Documentation")
print("="*50)

# Create README.md
readme_content = """# Safaricom Stock Analysis Project
...
# Data (if you don't want to commit large files)
# *.csv
"""
...
with open('organize_project.py', 'w', encoding='utf-8') as f:
    f.write(structure_script)
print("✓ Created: organize_project.py")
...
Next: Organize your project structure
   Run: python organize_project.py
